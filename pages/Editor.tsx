                ...
                <div className="flex-1 overflow-y-auto bg-slate-100 dark:bg-[#0b1219] p-4 md:p-8 flex justify-center relative">
                    {!showVersionHistory ? (
                        <div className="w-full max-w-[850px] min-h-[1100px] bg-white dark:bg-[#1c2128] shadow-sm dark:shadow-2xl border border-slate-200 dark:border-none p-12 md:p-16 mb-20 transition-colors cursor-text focus-within:ring-1 focus-within:ring-primary/20 outline-none">
                            ...
                            <div className="editor-content text-lg leading-relaxed text-slate-700 dark:text-slate-300 space-y-6" contentEditable="true">
                ...
                {showAI && (
                    <aside className="w-80 md:w-96 flex flex-col border-l border-slate-200 dark:border-border-dark bg-white dark:bg-background-dark shrink-0 z-20 shadow-xl absolute md:relative right-0 h-full animate-fade-in-up">
                        ...
                        <div className="flex-1 overflow-y-auto p-4 space-y-4">
                            <div className="flex gap-3">
                                <div className="size-8 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center text-white shrink-0 mt-1"><span className="material-symbols-outlined text-[18px]">smart_toy</span></div>
                                <div className="p-3 bg-slate-100 dark:bg-surface-dark rounded-2xl rounded-tl-none text-sm text-slate-700 dark:text-slate-300"><p>Merhaba! Belgen üzerinde çalışıyorsun. Sana nasıl yardımcı olabilirim?</p></div>
                            </div>
                             <div className="mt-6">
                                <h4 className="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-3">Hızlı İşlemler</h4>
                                <div className="grid grid-cols-1 gap-2">
                                    <button className="flex items-center gap-3 p-3 rounded-lg bg-white dark:bg-surface-dark border border-slate-200 dark:border-slate-700 hover:border-primary/50 text-left transition-colors">
                        ...
                        <div className="p-4 border-t border-slate-200 dark:border-border-dark">
                            <div className="relative">
                                <textarea className="w-full bg-slate-100 dark:bg-surface-dark border border-slate-200 dark:border-slate-700 rounded-lg pl-3 pr-10 py-3 text-sm resize-none h-12 dark:text-white focus:ring-1 focus:ring-primary outline-none" placeholder="AI'ya komut ver..."></textarea>
                                <button className="absolute right-2 top-2 p-1.5 text-primary hover:text-blue-600"><span className="material-symbols-outlined text-[20px]">send</span></button>
                            </div>
                        </div>
                    </aside>
                )}
